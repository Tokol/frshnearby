...
class MockCustomerMarketplaceRepository
  ...
  Future<void> replaceFarmerListings({
    ...
    _marketplaceListings.removeWhere((listing) => listing.farmerId == farmerId);
...
const _seedFarmers = [
  ...
  FarmerPublicProfile(
    id: 'farmer-3',
    displayName: 'Lakeview Pastures',
    farmName: 'Lakeview Pastures',
    city: 'Vaasa',
    country: 'Finland',
    rating: 4.7,
    reviewCount: 58,
    status: FarmerVerificationStatus.verified,
    shortDescription: 'Pasture-raised meat, eggs, and small dairy batches.',
    pickupNote: 'Pickup today 16:00-19:00 or chilled delivery nearby.',
    pickupAvailable: true,
    pickupAtFarm: true,
    pickupAddress: 'Lakeview farm gate, Vaasa',
  ),
  FarmerPublicProfile(
    id: 'farmer-pending',
...
final _seedListings = [
  ...
  Listing(
    id: 'public-listing-lamb-hot-sale',
    farmerId: 'farmer-3',
    categoryId: 'category-meat',
    productId: 'product-lamb',
    title: 'Fresh lamb chops',
    description:
        'Small-batch pasture lamb, cut this morning and packed for chilled pickup.',
    quantity: 8,
    unit: 'kg',
    price: 18.9,
    latitude: 63.0951,
    ...
    harvestDate: DateTime(2026, 6, 26),
    bestBeforeDate: DateTime(2026, 6, 29),
    farmingMethod: 'Pasture-raised, small batch',
    storageInstructions:
        'Keep chilled at 0-4 C. Freeze the same day if storing.',
    pickupNotes: 'Chilled pickup today 16:00-19:00. Delivery within Vaasa.',
    deliveryEnabled: true,
  ),
  Listing(
    id: 'public-listing-ground-beef-hot-sale',
    farmerId: 'farmer-3',
    categoryId: 'category-meat',
    productId: 'product-beef',
    variantId: 'variant-ground-beef',
    title: 'Ground beef',
    description:
        'Fresh ground beef from Lakeview Pastures, packed in 500 g portions.',
    quantity: 14,
    unit: 'kg',
    price: 13.5,
    latitude: 63.0951,
    ...
    createdAt: DateTime(2026, 6, 25),
    harvestDate: DateTime(2026, 6, 26),
    bestBeforeDate: DateTime(2026, 6, 28),
    farmingMethod: 'Grass-fed beef',
    storageInstructions: 'Keep chilled. Best cooked or frozen within 2 days.',
    pickupNotes: 'Packed cold and ready for same-day pickup.',
    deliveryEnabled: true,
  ),
  Listing(
    id: 'public-listing-lakeview-eggs',
    farmerId: 'farmer-3',
    categoryId: 'category-eggs',
    productId: 'product-egg',
    variantId: 'variant-free-range-egg',
    title: 'Free-range eggs',
    description: 'Collected yesterday from free-range hens.',
    quantity: 20,
    unit: 'tray',
    price: 5.9,
    latitude: 63.0951,
    ...
    pickupNotes: 'Available with any meat pickup.',
  ),
  Listing(
    id: 'public-listing-lakeview-milk',
    farmerId: 'farmer-3',
    categoryId: 'category-dairy',
    productId: 'product-milk',
    title: 'Farm milk',
    description: 'Fresh chilled farm milk in returnable bottles.',
    quantity: 16,
    unit: 'bottle',
    price: 3.2,
    latitude: 63.0951,
    ...
    createdAt: DateTime(2026, 6, 24),
    harvestDate: DateTime(2026, 6, 26),
    storageInstructions: 'Keep chilled and return bottle on next pickup.',
    pickupNotes: 'Can be packed with meat orders.',
  ),
  Listing(
    id: 'sold-out-apple',
    farmerId: 'farmer-1',
